...
marion = User.new(company: company1, city: london, location: "London, Greater London, England, United Kingdom", email: 'marion@airbnbeer.remost', password: 123456, first_name: 'Marion', last_name: 'Salaun', job_title: 'Speedy Onboarding Specialist', department: "HR & Talent", languages: ['English', 'French', 'Spanish', 'Dutch'], open_to: ['💻 Working together/side-by-side', '🍻 Drinks', '💬 Casual chat'], slack_user: 'U03PQD9E3M1')
...
john = User.new(company: company1, city: paris, location: "Paris, France", email: 'john@airbnbeer.remost', password: 123456, first_name: 'John', last_name: 'Smith', job_title: 'Forward Operations Engineer', department: "Operations", languages: ['English', 'French'], open_to: ['💻 Working together/side-by-side', '☕ Coffee', '💬 Casual chat'], slack_user: 'U03PQD9E3M1')
...
bob = User.new(company: company1, city: london, location: "London, Greater London, England, United Kingdom", email: 'bob@airbnbeer.remost', password: 123456, first_name: 'Bob', last_name: 'MacFarlane', job_title: 'Legacy Branding Associate', department: "Marketing & Comms", languages: ['English', 'Scots'], open_to: ['💻 Working together/side-by-side', '🍻 Drinks', '💬 Casual chat'], slack_user: 'U03PQD9E3M1')
...
jeanne = User.new(company: company1, city: london, location: "London, Greater London, England, United Kingdom", email: 'jeanne@airbnbeer.remost', password: 123456, first_name: 'Jeanne', last_name: 'Dupont', job_title: 'Internal Tactics Technician', department: "Sales & Growth", languages: ['English', 'French', 'Spanish'], open_to: ['💻 Working together/side-by-side', '☕ Coffee', '🍲 Dinner'], slack_user: 'U03PQD9E3M1')
...
leah = User.new(company: company1, city: london, location: "London, Greater London, England, United Kingdom", email: 'leah@airbnbeer.remost', password: 123456, first_name: 'Leah', last_name: 'Johnson', job_title: 'Chief Response Officer', department: "Sales & Growth", languages: ['English', 'Hebrew'], open_to: ['💻 Working together/side-by-side', '🏃 Weekend activity/meal', '💬 Casual chat'], slack_user: 'U03PQD9E3M1')
...
anastasia = User.new(company: company1, city: dublin, location: "Dublin, Ireland", email: 'anastasia@airbnbeer.remost', password: 123456, first_name: 'Anastasia', last_name: 'Golubeva', job_title: 'Product Resonance Designer', department: "Product & Design", languages: ['English', 'Russian'], open_to: ['💻 Working together/side-by-side', '🏃 Weekend activity/meal', '🍲 Dinner'], slack_user: 'U03PQD9E3M1')
...
bertrand = User.new(company: company1, city: london, location: "London, Greater London, England, United Kingdom", email: 'bertrand@airbnbeer.remost', password: 123456, first_name: 'Bertrand', last_name: 'Martinot', job_title: 'Internal Security Architect', department: 'Engineering', languages: ['English', 'French'], open_to: ['💡 Brainstorming', '🍲 Lunch'], slack_user: 'U03PQD9E3M1')
...
anthony = User.new(company: company1, city: berlin, location: "Berlin, Germany", email: 'anthony@airbnbeer.remost', password: 123456, first_name: 'Anthony', last_name: 'Balkus', job_title: 'Future Web Sales Associate', department: "Sales & Growth", languages: ['English', 'Lithuanian', 'German'], open_to: ['🍻 Drinks', '🍲 Dinner'], slack_user: 'U03PQD9E3M1')
...
nick = User.new(company: company1, city: berlin, location: "Berlin, Germany", email: 'nick@airbnbeer.remost', password: 123456, first_name: 'Nick', last_name: 'Bain', job_title: 'Central Ideation Consultant', department: "Sales & Growth", languages: ['English', 'Spanish', 'Polish'], open_to: ['💻 Working together/side-by-side', '🏃 Weekend activity/meal', '🥐 Breakfast'], slack_user: 'U03PQD9E3M1')
...
beatriz = User.new(company: company1, city: london, location: "London, Greater London, England, United Kingdom", email: 'beatriz@airbnbeer.remost', password: 123456, first_name: 'Beatriz', last_name: 'Bakker', job_title: 'Product Accountability Senior Intern', department: "Product & Design", languages: ['English', 'Spanish', 'Dutch'], open_to: ['💡 Brainstorming', '🍲 Dinner'], slack_user: 'U03PQD9E3M1')
...
pavel = User.new(company: company1, city: zurich, location: "Zürich, Zürich, Switzerland", email: 'pavel@airbnbeer.remost', password: 123456, first_name: 'Pavel', last_name: 'Ivanov', job_title: 'Legacy Quality Planner', department: "Product & Design", languages: ['English', 'Russian'], open_to: ['☕ Coffee', '💬 Casual chat', '🤝 Networking at an event'], slack_user: 'U03PQD9E3M1')
...
sam = User.new(company: company1, city: dublin, location: "Dublin, Ireland", email: 'sam@airbnbeer.remost', password: 123456, first_name: 'Sam', last_name: 'Byrne', job_title: 'Dynamic Product Specialist', department: "Product & Design", languages: ['English', 'Irish Gaelic'], open_to: ['💻 Working together/side-by-side', '🍻 Drinks', '🍲 Lunch'], slack_user: 'U03PQD9E3M1')
...
ed = User.new(company: company1, city: paris, location: "Paris, France", email: 'ed@airbnbeer.remost', password: 123456, first_name: 'Ed', last_name: 'Wilson', job_title: 'Senior Accounting Orchestrator', department: "Finance & Accounting", languages: ['English', 'French'], open_to: ['💻 Working together/side-by-side', '☕ Coffee', '🥐 Breakfast'], slack_user: 'U03PQD9E3M1')
...
charlie = User.new(company: company1, city: dublin, location: "Dublin, Ireland", email: 'charlie@airbnbeer.remost', password: 123456, first_name: 'Charlie', last_name: 'Rossi', job_title: 'Head of Corporate Resonance', department: "Sales & Growth", languages: ['English', 'Italian'], open_to: ['💻 Working together/side-by-side', '🍻 Drinks'], slack_user: 'U03PQD9E3M1')
...
mina = User.new(company: company1, city: amsterdam, location: "Amsterdam, North Holland, Netherlands", email: 'mina@airbnbeer.remost', password: 123456, first_name: 'Mina', last_name: 'Heikkinnen', job_title: 'Sales Quality Representative', department: "Sales & Growth", languages: ['English', 'Finnish'], open_to: ['💻 Working together/side-by-side', '☕ Coffee', '🥐 Breakfast'], slack_user: 'U03PQD9E3M1')
...
anton = User.new(company: company1, city: madrid, location: "Madrid, Madrid, Spain", email: 'anton@airbnbeer.remost', password: 123456, first_name: 'Anton', last_name: 'Schmid', job_title: 'Talent Security Director', department: "HR & Talent", languages: ['English', 'Spanish', 'German'], open_to: ['💡 Brainstorming', '☕ Coffee', '🏃 Weekend activity/meal'], slack_user: 'U03PQD9E3M1')
...
ina = User.new(company: company1, city: berlin, location: "Berlin, Germany", email: 'ina@airbnbeer.remost', password: 123456, first_name: 'Ina', last_name: 'Demir', job_title: 'Interactive Identity Agent', department: "HR & Talent", languages: ['English', 'German'], open_to: ['💻 Working together/side-by-side', '🍻 Drinks', '💡 Brainstorming'], slack_user: 'U03PQD9E3M1')
...
anjali = User.new(company: company1, city: brussels, location: "Brussels, Brussels-Capital, Belgium", email: 'anjali@airbnbeer.remost', password: 123456, first_name: 'Anjali', last_name: 'Adhvaryu', job_title: 'Product Growth Marketing Branding Officer', department: "Marketing & Comms", languages: ['English', 'Gujarati'], open_to: ['💻 Working together/side-by-side', '☕ Coffee', '🥐 Breakfast'], slack_user: 'U03PQD9E3M1')
...
aakash = User.new(company: company1, city: amsterdam, location: "Amsterdam, North Holland, Netherlands", email: 'aakash@airbnbeer.remost', password: 123456, first_name: 'Aakash', last_name: 'Patel', job_title: 'Senior Full-end Engineer', department: 'Engineering', languages: ['English', 'Hindi'], open_to: ['💻 Working together/side-by-side', '☕ Coffee', '💡 Brainstorming'], slack_user: 'U03PQD9E3M1')
...
fang = User.new(company: company1, city: london, location: "London, Greater London, England, United Kingdom", email: 'fang@airbnbeer.remost', password: 123456, first_name: 'Fang', last_name: 'Zhang', job_title: 'Global Legal Intern', department: "Administrative", languages: ['English', 'Portuguese'], open_to: ['💻 Working together/side-by-side', '☕ Coffee'], slack_user: 'U03PQD9E3M1')
...
alba = User.new(company: company1, city: london, location: "London, Greater London, England, United Kingdom", email: 'alba@airbnbeer.remost', password: 123456, first_name: 'Alba', last_name: 'Perez', job_title: 'Lead Travel Administrator', department: "HR & Talent", languages: ['English', 'Spanish'], open_to: ['💻 Working together/side-by-side', '🍻 Drinks'], slack_user: 'U03PQD9E3M1')
...
effia = User.new(company: company1, city: brussels, location: "Brussels, Brussels-Capital, Belgium", email: 'effia@airbnbeer.remost', password: 123456, first_name: 'Effia', last_name: 'Akakpo', job_title: 'Lead Growth Engineer', department: "Sales & Growth", languages: ['English', 'French'], open_to: ['💻 Working together/side-by-side', '☕ Coffee', '🏃 Weekend activity/meal'], slack_user: 'U03PQD9E3M1')
...
benjamin = User.new(company: company1, city: london, location: "London, Greater London, England, United Kingdom", email: 'benjamin@airbnbeer.remost', password: 123456, first_name: 'Benjamin', last_name: 'Muller', job_title: 'Technical Debt Designer', department: "Product & Design", languages: ['English', 'German'], open_to: ['💻 Working together/side-by-side', '💬 Casual chat', '🍻 Drinks'], slack_user: 'U03PQD9E3M1')
...
marion2 = User.new(company: company2, city: budapest, location: "Budapest, Hungary", email: 'marion2@exciting.remost', password: 123456, first_name: 'Marion2', last_name: 'Salaun2', job_title: 'Speedy Onboarding Specialist', department: "HR & Talent", languages: ['English', 'French', 'Spanish', 'Dutch'], open_to: ['💻 Working together/side-by-side', '🍻 Drinks', '💬 Casual chat'], slack_user: 'U03PQD9E3M1')
...
john2 = User.new(company: company2, city: vienna, location: "Vienna, Austria", email: 'john2@exciting.remost', password: 123456, first_name: 'John2', last_name: 'Smith2', job_title: 'Forward Operations Engineer', department: "Operations", languages: ['English', 'French'], open_to: ['💻 Working together/side-by-side', '☕ Coffee', '💬 Casual chat'], slack_user: 'U03PQD9E3M1')
...
bob2 = User.new(company: company2, city: budapest, location: "Budapest, Hungary", email: 'bob2@exciting.remost', password: 123456, first_name: 'Bob2', last_name: 'MacFarlane2', job_title: 'Legacy Branding Associate', department: "Marketing & Comms", languages: ['English', 'Scots'], open_to: ['💻 Working together/side-by-side', '🍻 Drinks', '💬 Casual chat'], slack_user: 'U03PQD9E3M1')
...
jeanne2 = User.new(company: company2, city: budapest, location: "Budapest, Hungary", email: 'jeanne2@exciting.remost', password: 123456, first_name: 'Jeanne2', last_name: 'Dupont2', job_title: 'Internal Tactics Technician', department: "Sales & Growth", languages: ['English', 'French', 'Spanish'], open_to: ['💻 Working together/side-by-side', '☕ Coffee', '🍲 Dinner'], slack_user: 'U03PQD9E3M1')
...
leah2 = User.new(company: company2, city: budapest, location: "Budapest, Hungary", email: 'leah2@exciting.remost', password: 123456, first_name: 'Leah2', last_name: 'Johnson2', job_title: 'Chief Response Officer', department: "Sales & Growth", languages: ['English', 'Hebrew'], open_to: ['💻 Working together/side-by-side', '🏃 Weekend activity/meal', '💬 Casual chat'], slack_user: 'U03PQD9E3M1')
...
anastasia2 = User.new(company: company2, city: bratislava, location: "Bratislava, Bratislava, Slovakia", email: 'anastasia2@exciting.remost', password: 123456, first_name: 'Anastasia2', last_name: 'Golubeva2', job_title: 'Product Resonance Designer', department: "Product & Design", languages: ['English', 'Russian'], open_to: ['💻 Working together/side-by-side', '🏃 Weekend activity/meal', '🍲 Dinner'], slack_user: 'U03PQD9E3M1')
...
bertrand2 = User.new(company: company2, city: budapest, location: "Budapest, Hungary", email: 'bertrand2@exciting.remost', password: 123456, first_name: 'Bertrand2', last_name: 'Martinot2', job_title: 'Internal Security Architect', department: 'Engineering', languages: ['English', 'French'], open_to: ['💡 Brainstorming', '🍲 Lunch'], slack_user: 'U03PQD9E3M1')
...
anthony2 = User.new(company: company2, city: zagreb, location: "Zagreb, Zagreb, Croatia", email: 'anthony2@exciting.remost', password: 123456, first_name: 'Anthony2', last_name: 'Balkus2', job_title: 'Future Web Sales Associate', department: "Sales & Growth", languages: ['English', 'Lithuanian', 'German'], open_to: ['🍻 Drinks', '🍲 Dinner'], slack_user: 'U03PQD9E3M1')
...
nick2 = User.new(company: company2, city: zagreb, location: "Zagreb, Zagreb, Croatia", email: 'nick2@exciting.remost', password: 123456, first_name: 'Nick2', last_name: 'Bain2', job_title: 'Central Ideation Consultant', department: "Sales & Growth", languages: ['English', 'Spanish', 'Polish'], open_to: ['💻 Working together/side-by-side', '🏃 Weekend activity/meal', '🥐 Breakfast'], slack_user: 'U03PQD9E3M1')
...
beatriz2 = User.new(company: company2, city: budapest, location: "Budapest, Hungary", email: 'beatriz2@exciting.remost', password: 123456, first_name: 'Beatriz2', last_name: 'Bakker2', job_title: 'Product Accountability Senior Intern', department: "Product & Design", languages: ['English', 'Spanish', 'Dutch'], open_to: ['💡 Brainstorming', '🍲 Dinner'], slack_user: 'U03PQD9E3M1')
...
pavel2 = User.new(company: company2, city: prague, location: "Prague, Prague, Czech Republic", email: 'pavel2@exciting.remost', password: 123456, first_name: 'Pavel2', last_name: 'Ivanov2', job_title: 'Legacy Quality Planner', department: "Product & Design", languages: ['English', 'Russian'], open_to: ['☕ Coffee', '💬 Casual chat', '🤝 Networking at an event'], slack_user: 'U03PQD9E3M1')
...
sam2 = User.new(company: company2, city: bratislava, location: "Bratislava, Bratislava, Slovakia", email: 'sam2@exciting.remost', password: 123456, first_name: 'Sam2', last_name: 'Byrne2', job_title: 'Dynamic Product Specialist', department: "Product & Design", languages: ['English', 'Irish Gaelic'], open_to: ['💻 Working together/side-by-side', '🍻 Drinks', '🍲 Lunch'], slack_user: 'U03PQD9E3M1')
...
ed2 = User.new(company: company2, city: vienna, location: "Vienna, Austria", email: 'ed2@exciting.remost', password: 123456, first_name: 'Ed2', last_name: 'Wilson2', job_title: 'Senior Accounting Orchestrator', department: "Finance & Accounting", languages: ['English', 'French'], open_to: ['💻 Working together/side-by-side', '☕ Coffee', '🥐 Breakfast'], slack_user: 'U03PQD9E3M1')
...
charlie2 = User.new(company: company2, city: bratislava, location: "Bratislava, Bratislava, Slovakia", email: 'charlie2@exciting.remost', password: 123456, first_name: 'Charlie2', last_name: 'Rossi2', job_title: 'Head of Corporate Resonance', department: "Sales & Growth", languages: ['English', 'Italian'], open_to: ['💻 Working together/side-by-side', '🍻 Drinks'], slack_user: 'U03PQD9E3M1')
...
mina2 = User.new(company: company2, city: rome, location: "Rome, Rome, Italy", email: 'mina2@exciting.remost', password: 123456, first_name: 'Mina2', last_name: 'Heikkinnen2', job_title: 'Sales Quality Representative', department: "Sales & Growth", languages: ['English', 'Finnish'], open_to: ['💻 Working together/side-by-side', '☕ Coffee', '🥐 Breakfast'], slack_user: 'U03PQD9E3M1')
...
anton2 = User.new(company: company2, city: prague, location: "Prague, Prague, Czech Republic", email: 'anton2@exciting.remost', password: 123456, first_name: 'Anton2', last_name: 'Schmid2', job_title: 'Talent Security Director', department: "HR & Talent", languages: ['English', 'Spanish', 'German'], open_to: ['💡 Brainstorming', '☕ Coffee', '🏃 Weekend activity/meal'], slack_user: 'U03PQD9E3M1')
...
ina2 = User.new(company: company2, city: zagreb, location: "Zagreb, Zagreb, Croatia", email: 'ina2@exciting.remost', password: 123456, first_name: 'Ina2', last_name: 'Demir2', job_title: 'Interactive Identity Agent', department: "HR & Talent", languages: ['English', 'German'], open_to: ['💻 Working together/side-by-side', '🍻 Drinks', '💡 Brainstorming'], slack_user: 'U03PQD9E3M1')
...
anjali2 = User.new(company: company2, city: prague, location: "Prague, Prague, Czech Republic", email: 'anjali2@exciting.remost', password: 123456, first_name: 'Anjali2', last_name: 'Adhvaryu2', job_title: 'Product Growth Marketing Branding Officer', department: "Marketing & Comms", languages: ['English', 'Gujarati'], open_to: ['💻 Working together/side-by-side', '☕ Coffee', '🥐 Breakfast'], slack_user: 'U03PQD9E3M1')
...
aakash2 = User.new(company: company2, city: rome, location: "Rome, Rome, Italy", email: 'aakash2@exciting.remost', password: 123456, first_name: 'Aakash2', last_name: 'Patel2', job_title: 'Senior Full-end Engineer', department: 'Engineering', languages: ['English', 'Hindi'], open_to: ['💻 Working together/side-by-side', '☕ Coffee', '💡 Brainstorming'], slack_user: 'U03PQD9E3M1')
...
paul2 = User.new(company: company2, city: rome, location: "Rome, Rome, Italy", email: 'paul2@exciting.remost', password: 123456, first_name: 'Paul2', last_name: 'Harris2', job_title: 'Relational Java Associate', department: 'Engineering', languages: ['English', 'Portuguese'], open_to: ['💻 Working together/side-by-side', '☕ Coffee', '💡 Brainstorming'], slack_user: 'U03PQD9E3M1')
...
fang2 = User.new(company: company2, city: budapest, location: "Budapest, Hungary", email: 'fang2@exciting.remost', password: 123456, first_name: 'Fang2', last_name: 'Zhang2', job_title: 'Global Legal Intern', department: "Administrative", languages: ['English', 'Portuguese'], open_to: ['💻 Working together/side-by-side', '☕ Coffee'], slack_user: 'U03PQD9E3M1')
...
alba2 = User.new(company: company2, city: budapest, location: "Budapest, Hungary", email: 'alba2@exciting.remost', password: 123456, first_name: 'Alba2', last_name: 'Perez2', job_title: 'Lead Travel Administrator', department: "HR & Talent", languages: ['English', 'Spanish'], open_to: ['💻 Working together/side-by-side', '🍻 Drinks'], slack_user: 'U03PQD9E3M1')
...
effia2 = User.new(company: company2, city: prague, location: "Prague, Prague, Czech Republic", email: 'effia2@exciting.remost', password: 123456, first_name: 'Effia2', last_name: 'Akakpo2', job_title: 'Lead Growth Engineer', department: "Sales & Growth", languages: ['English', 'French'], open_to: ['💻 Working together/side-by-side', '☕ Coffee', '🏃 Weekend activity/meal'], slack_user: 'U03PQD9E3M1')
...
benjamin2 = User.new(company: company2, city: budapest, location: "Budapest, Hungary", email: 'benjamin2@exciting.remost', password: 123456, first_name: 'Benjamin2', last_name: 'Muller2', job_title: 'Technical Debt Designer', department: "Product & Design", languages: ['English', 'German'], open_to: ['💻 Working together/side-by-side', '💬 Casual chat', '🍻 Drinks'], slack_user: 'U03PQD9E3M1')
...
trip1 = Trip.create!(user: john, city: dublin, destination: "Dublin, Ireland", start_date: 'Sun, 15 Jan 2023', end_date: 'Tue, 31 Jan 2023')
trip2 = Trip.create!(user: bob, city: brussels, destination: "Brussels, Brussels-Capital, Belgium", start_date: 'Wed, 01 Feb 2023', end_date: 'Sat, 18 Feb 2023')
trip3 = Trip.create!(user: jeanne, city: amsterdam, destination: "Amsterdam, North Holland, Netherlands", start_date: 'Sun, 5 Mar 2023', end_date: 'Sun, 26 Mar 2023')
trip4 = Trip.create!(user: leah, city: amsterdam, destination: "Amsterdam, North Holland, Netherlands", start_date: 'Mon, 6 Mar 2023', end_date: 'Thu, 16 Mar 2023')

trip5 = Trip.create!(user: anastasia, city: london, destination: "London, Greater London, England, United Kingdom", start_date: 'Sun, 15 Jan 2023', end_date: 'Fri, 20 Jan 2023')
trip7 = Trip.create!(user: anastasia, city: paris, destination: "Paris, France", start_date: 'Sat, 21 Jan 2023', end_date: 'Thu, 26 Jan 2023')
trip8 = Trip.create!(user: anastasia, city: madrid, destination: "Madrid, Madrid, Spain", start_date: 'Fri, 27 Jan 2023', end_date: 'Mon, 30 Jan 2023')
trip9 = Trip.create!(user: anastasia, city: zurich, destination: "Zürich, Zürich, Switzerland", start_date: 'Sat, 18 Feb 2023', end_date: 'Thu, 23 Feb 2023')
trip10 = Trip.create!(user: anastasia, city: amsterdam, destination: "Amsterdam, North Holland, Netherlands", start_date: 'Fri, 24 Feb 2023', end_date: 'Tue, 28 Feb 2023')
trip11 = Trip.create!(user: anastasia, city: copenhagen, destination: "Copenhagen, Capital Region of Denmark, Denmark", start_date: 'Sun, 5 Mar 2023', end_date: 'Sun, 19 Mar 2023')

trip12 = Trip.create!(user: leah, city: london, destination: "London, Greater London, England, United Kingdom", start_date: 'Mon, 20 Mar 2023', end_date: 'Mon, 27 Mar 2023')
trip13 = Trip.create!(user: jeanne, city: paris, destination: "Paris, France", start_date: 'Sun, 22 Jan 2023', end_date: 'Sat, 28 Jan 2023')
trip14 = Trip.create!(user: bob, city: paris, destination: "Paris, France", start_date: 'Mon, 23 Jan 2023', end_date: 'Sat, 28 Jan 2023')
trip15 = Trip.create!(user: sam, city: paris, destination: "Paris, France", start_date: 'Mon, 23 Jan 2023', end_date: 'Sat, 28 Jan 2023')
trip16 = Trip.create!(user: ed, city: london, destination: "London, Greater London, England, United Kingdom", start_date: 'Tue, 17 Jan 2023', end_date: 'Fri, 20 Jan 2023')
trip17 = Trip.create!(user: pavel, city: paris, destination: "Paris, France", start_date: 'Mon, 23 Jan 2023', end_date: 'Sun, 29 Jan 2023')
trip18 = Trip.create!(user: anthony, city: dublin, destination: "Dublin, Ireland", start_date: 'Wed, 01 Feb 2023', end_date: 'Wed, 8 Feb 2023')

trip19 = Trip.create!(user: marion, city: dublin, destination: "Dublin, Ireland", start_date: 'Fri, 17 Feb 2023', end_date: 'Tue, 28 Feb 2023')
trip20 = Trip.create!(user: marion, city: lisbon, destination: "Lisbon, Lisbon, Portugal", start_date: 'Fri, 3 Mar 2023', end_date: 'Mon, 6 Mar 2023')
trip21 = Trip.create!(user: marion, city: amsterdam, destination: "Amsterdam, North Holland, Netherlands", start_date: 'Tue, 21 Mar 2023', end_date: 'Mon, 27 Mar 2023')
trip22 = Trip.create!(user: marion, city: madrid, destination: "Madrid, Madrid, Spain", start_date: 'Sun, 2 Apr 2023', end_date: 'Tue, 11 Apr 2023')


################## COMPANY 2 - TRIPS (cloned users, same cities, same dates - same names but with a 'b' at the end) ##################

trip1b = Trip.create!(user: john2, city: dublin, destination: "Dublin, Ireland", start_date: 'Sun, 15 Jan 2023', end_date: 'Tue, 31 Jan 2023')
trip2b = Trip.create!(user: bob2, city: brussels, destination: "Brussels, Brussels-Capital, Belgium", start_date: 'Wed, 01 Feb 2023', end_date: 'Sat, 18 Feb 2023')
trip3b = Trip.create!(user: jeanne2, city: amsterdam, destination: "Amsterdam, North Holland, Netherlands", start_date: 'Sun, 5 Mar 2023', end_date: 'Sun, 26 Mar 2023')
trip4b = Trip.create!(user: leah2, city: amsterdam, destination: "Amsterdam, North Holland, Netherlands", start_date: 'Mon, 6 Mar 2023', end_date: 'Thu, 16 Mar 2023')

trip5b = Trip.create!(user: anastasia2, city: london, destination: "London, Greater London, England, United Kingdom", start_date: 'Sun, 15 Jan 2023', end_date: 'Fri, 20 Jan 2023')
trip7b = Trip.create!(user: anastasia2, city: paris, destination: "Paris, France", start_date: 'Sat, 21 Jan 2023', end_date: 'Thu, 26 Jan 2023')
trip8b = Trip.create!(user: anastasia2, city: madrid, destination: "Madrid, Madrid, Spain", start_date: 'Fri, 27 Jan 2023', end_date: 'Mon, 30 Jan 2023')
trip9b = Trip.create!(user: anastasia2, city: zurich, destination: "Zürich, Zürich, Switzerland", start_date: 'Sat, 18 Feb 2023', end_date: 'Thu, 23 Feb 2023')
trip10b = Trip.create!(user: anastasia2, city: amsterdam, destination: "Amsterdam, North Holland, Netherlands", start_date: 'Fri, 24 Feb 2023', end_date: 'Tue, 28 Feb 2023')
trip11b = Trip.create!(user: anastasia2, city: copenhagen, destination: "Copenhagen, Capital Region of Denmark, Denmark", start_date: 'Sun, 5 Mar 2023', end_date: 'Sun, 19 Mar 2023')

trip12b = Trip.create!(user: leah2, city: london, destination: "London, Greater London, England, United Kingdom", start_date: 'Mon, 20 Mar 2023', end_date: 'Mon, 27 Mar 2023')
trip13b = Trip.create!(user: jeanne2, city: paris, destination: "Paris, France", start_date: 'Sun, 22 Jan 2023', end_date: 'Sat, 28 Jan 2023')
trip14b = Trip.create!(user: bob2, city: paris, destination: "Paris, France", start_date: 'Mon, 23 Jan 2023', end_date: 'Sat, 28 Jan 2023')
trip15b = Trip.create!(user: sam2, city: paris, destination: "Paris, France", start_date: 'Mon, 23 Jan 2023', end_date: 'Sat, 28 Jan 2023')
trip16b = Trip.create!(user: ed2, city: london, destination: "London, Greater London, England, United Kingdom", start_date: 'Tue, 17 Jan 2023', end_date: 'Fri, 20 Jan 2023')
trip17b = Trip.create!(user: pavel2, city: paris, destination: "Paris, France", start_date: 'Mon, 23 Jan 2023', end_date: 'Sun, 29 Jan 2023')
trip18b = Trip.create!(user: anthony2, city: dublin, destination: "Dublin, Ireland", start_date: 'Wed, 01 Feb 2023', end_date: 'Wed, 8 Feb 2023')

trip19b = Trip.create!(user: marion2, city: dublin, destination: "Dublin, Ireland", start_date: 'Fri, 17 Feb 2023', end_date: 'Tue, 28 Feb 2023')
trip20b = Trip.create!(user: marion2, city: lisbon, destination: "Lisbon, Lisbon, Portugal", start_date: 'Fri, 3 Mar 2023', end_date: 'Mon, 6 Mar 2023')
trip21b = Trip.create!(user: marion2, city: amsterdam, destination: "Amsterdam, North Holland, Netherlands", start_date: 'Tue, 21 Mar 2023', end_date: 'Mon, 27 Mar 2023')
trip22b = Trip.create!(user: marion2, city: madrid, destination: "Madrid, Madrid, Spain", start_date: 'Sun, 2 Apr 2023', end_date: 'Tue, 11 Apr 2023')
