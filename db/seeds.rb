...
################## USED FOR TIPS BY BOTH USERS OF COMPANY1 AND COMPANY2 (with a 'b' at the end of the name) ##################
...
place19 = Place.create!(company: company1, location: 'Place de la Concorde, Paris, France', city: paris, name: 'Jardin des Tuileries', category: '🎾 Sports')
...
tip1b = Tip.create!(user: john2, place: place1, content: 'Just amazing, despite the ongoing works after the big fire. Strongly recommended!', rating: 5)
tip2b = Tip.create!(user: john2, place: place2, content: 'Cheap food, in a typical Parisian bistro atmosphere. Beautiful, but queues can be veeery long.', rating: 4)
tip3b = Tip.create!(user: bob2, place: place3, content: 'Just the best (and most beautiful!) WeWork in Paris! Half the remote workers travelling to Paris stop there at some point.', rating: 5)
tip4b = Tip.create!(user: jeanne2, place: place4, content: 'Very Harry-Potteresque, but full of bankers having a pint after work. Worth a quick visit.', rating: 4)
tip5b = Tip.create!(user: leah2, place: place5, content: 'My favourite temple in London by far! Everyone is lovely.', rating: 5)
tip6b = Tip.create!(user: leah2, place: place6, content: 'Just a classic in the middle of Dublin. Very, very busy at times.', rating: 4)
tip7b = Tip.create!(user: anastasia2, place: place7, content: 'Nice to see at least once, but some will be disappointed...', rating: 3)
tip8b = Tip.create!(user: anastasia2, place: place8, content: "Many folks from our company come here when stopping by Brussels. The WeWork manager is my friend, so drop me a line if you're around and you'll get some perks!", rating: 5)
tip9b = Tip.create!(user: sam2, place: place9, content: "Typical Portuguese food, lovely service, in the middle of the party district.", rating: 8)
tip10b = Tip.create!(user: bertrand2, place: place10, content: "Perfect to try various cuisines! Very busy, you might have to fight a bit to get a table...", rating: 9)
tip11b = Tip.create!(user: nick2, place: place11, content: "Best spot to watch the sun set over the city. Also very interesting history.", rating: 9)
tip12b = Tip.create!(user: pavel2, place: place12, content: "Go at least once!", rating: 8)
tip13b = Tip.create!(user: beatriz2, place: place13, content: "My favorite coworking space in the city.", rating: 8)
tip14b = Tip.create!(user: ed2, place: place14, content: "One of the best restaurants I've ever been to!", rating: 9)
tip15b = Tip.create!(user: beatriz2, place: place15, content: "Definitely not cheap, but if you're in for some super luxe French food, that's the place to go!", rating: 9)
tip16b = Tip.create!(user: anthony2, place: place16, content: "By far the best bar I've been to in Dublin. Their cocktails are just incredible", rating: 9)
tip17b = Tip.create!(user: anastasia2, place: place17, content: "Decent CoWorking Space", rating: 7)
tip18b = Tip.create!(user: sam2, place: place18, content: "Some say it's the best cafe in Paris... I think I agree!", rating: 8)
tip19b = Tip.create!(user: ed2, place: place19, content: "Just the best place to go for a run, with a view on the river, musee du Louvre and its glass pyramid. Come early!", rating: 9)
tip20b = Tip.create!(user: nick2, place: place20, content: "Best Hindu temple in Paris. Recommended by a friend", rating: 8)
tip21b = Tip.create!(user: beatriz2, place: place21, content: "Just avoid this area at all costs at night, especially if you're alone. Lots of people roaming the street and strange behaviours...", rating: 0)
